      ...
      <section className="pt-32 pb-12 md:pt-40 md:pb-20 px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <span className="inline-block py-3 px-6 md:py-4 md:px-8 rounded-full bg-brand-blue/20 text-brand-medium-blue text-sm md:text-xl font-bold tracking-wide mb-6 md:mb-8 uppercase shadow-sm">
